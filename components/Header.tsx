      ...
      <div className="container flex items-center justify-between">
        ...
        <ul ref={sideMenuRef} className="w-64 bg-rose-100 h-screen fixed top-0 -right-64 flex md:hidden flex-col gap-4 px-4 py-1 bottom-0 transition-all ease-in-out duration-500">
          <div className="absolute top-2 right-2" onClick={closeMenu}>
            <span className="text-2xl cursor-pointer text-gray-800 hover:text-gray-600 transition-colors ease-in-out duration-300"><RxCross1 /></span>
          </div>
          <button className="w-20 py-2 flex items-center justify-center gap-2 text-sm md:text-lg 2xl:text-xl font-Ovo text-white bg-black rounded-full hover:bg-stone-600 transition-all ease-in duration-300"><span><LuSunMoon/></span>Light</button>
          <li className="mt-2"><a className="font-Ovo hover:text-gray-600 transition-colors ease-in duration-300" href="#hoem">Home</a></li>
          ...
          <li className=""><a className="font-Ovo  hover:text-gray-600 transition-colors ease-in duration-300" href="#testimonials">Testimonials</a></li>
        </ul>
      </div>
    </div>
  )
